...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Pramuka Indonesia</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
   ...
   <?php echo form_open('login/proseslogin');?>
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" name="login" value="submit" class="btn btn-primary btn-block btn-flat">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
    ...
    <a href="<?php echo base_url()?>register"> <strong>Daftar di sini</strong></a>
