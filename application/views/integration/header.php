    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
          <img src="<?php echo base_url()?>asset/dist/img/bakhtiar.jpg" class="user-image" alt="User Image">
          <span class="hidden-xs">Bakhtiar Shofawi</span>
        </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url()?>asset/dist/img/bakhtiar.jpg" class="img-circle" alt="User Image">

                <p>
                  Bakhtiar Shofawi - Web Developer
                  <small>Member since Juli 2018</small>
                </p>
              </li>
              <!-- Menu Body -->
