	...
	$pdf->AddPage();
       ...
       /* $pdf->SetFont('Arial','B',10);*/
        ...
        foreach ($sekolah as $row){
            $pdf->Cell(9,7,'Nama : ',0,0,'C');
            $pdf->Cell(56,7,$row->nama,0,1,'C');
            $pdf->Cell(23,7,'Tanggal Lahir : ',0,0,'C');
            $pdf->Cell(50,7,$row->tgl_lahir,0,1,'C');
            $pdf->Cell(23,7,'Jenis Kelamin : ',0,0,'C');
            $pdf->Cell(31,7,$row->jenis_kelamin,0,1,'C');
            $pdf->Cell(10,7,'Agama : ',0,0,'C');
            $pdf->Cell(65,7,$row->agama,0,1,'C');
            $pdf->Cell(28,7,'Golongan Darah : ',0,0,'C');
            $pdf->Cell(21,7,$row->gol_darah,0,1,'C');
            // $pdf->Cell(10,7,'Alamat : ',0,0,'C');
